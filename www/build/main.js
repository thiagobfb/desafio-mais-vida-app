        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_9_ionic_angular__["e" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_11__app_component__["a" /* MyApp */], {}, {
                    links: [
                        { loadChildren: '../pages/entities/medico-my-suffix/medico-my-suffix-detail.module#MedicoMySuffixDetailPageModule', name: 'MedicoMySuffixDetailPage', segment: 'medico-my-suffix-detail/:id', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/entities/entity.module#EntityPageModule', name: 'EntityPage', segment: 'entity', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/entities/medico-my-suffix/medico-my-suffix-dialog.module#MedicoMySuffixDialogPageModule', name: 'MedicoMySuffixDialogPage', segment: 'medico-my-suffix-dialog', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/entities/medico-my-suffix/medico-my-suffix.module#MedicoMySuffixPageModule', name: 'MedicoMySuffixPage', segment: 'medico-my-suffix', priority: 'low', defaultHistory: [] },
...
var EntityPage = (function () {
    ...
    EntityPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-entity',template:/*ion-inline-start:"/home/thiago/dev/desafio-mais-vida-app/maisvidadesafio/src/pages/entities/entity.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Entities\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-list>\n    <ion-item *ngFor="let entity of entities" (click)="openPage(entity)">\n      <h2>{{entity.name}}</h2>\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/home/thiago/dev/desafio-mais-vida-app/maisvidadesafio/src/pages/entities/entity.html"*/
        }),
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["c" /* TranslateService */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* Platform */], __WEBPACK_IMPORTED_MODULE_6__providers_providers__["b" /* Settings */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["b" /* Config */],
